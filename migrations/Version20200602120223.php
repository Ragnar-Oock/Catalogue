 ...
 */
final class Version20200602120223 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD commentaire VARCHAR(255) DEFAULT NULL, CHANGE validated_at validated_at DATETIME DEFAULT NULL, CHANGE last_edited_at last_edited_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reservation DROP commentaire, CHANGE validated_at validated_at DATETIME DEFAULT \'NULL\', CHANGE last_edited_at last_edited_at DATETIME DEFAULT \'NULL\'');
